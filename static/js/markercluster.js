...
MarkerClusterer.prototype.setupStyles_ = function () {
    if (this.styles_.length) {
        console.log('retornou direto')
        return;
    }

    for (var i = 0, size; size = this.sizes[i]; i++) {
        console.log('passando pra styles_', this.imagePath_)
        this.styles_.push({
            url: this.imagePath_,
            height: size,
            width: size
...
ClusterIcon.prototype.createCss = function (pos) {
    ...
    style.push('background-size:cover;' + 'background-position:' + backgroundPosition + ';');
